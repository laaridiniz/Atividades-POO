...
let s1 = new servico_1.default('URCNS', 'Unha', 15.00);
let s2 = new servico_1.default('KAMDD', 'Limpeza', 50.00);
let s3 = new servico_1.default('SFJID', 'Sobrancelha', 60.00);
let s4 = new servico_1.default('DSERg', 'Corte', 20.00);
let s5 = new servico_1.default('WEERF', 'Maquiagem', 70.00);
let s6 = new servico_1.default('TFRJE', 'Pedicure', 40.00);
let s7 = new servico_1.default('RTUTE', 'Botox', 80.00);
let s8 = new servico_1.default('WEHIW', 'Preenchimento', 45.00);
let s9 = new servico_1.default('RYIUJ', 'Cílios', 60.00);
let s10 = new servico_1.default('EHJFH', 'Depilação', 25.00);
let p1 = new produto_1.default('YJHDS', 'Xampu', 20.00);
let p2 = new produto_1.default('RTEYU', 'Esmalte', 15);
let p3 = new produto_1.default('RYTU7', 'Camisa', 30);
let p4 = new produto_1.default('YTJUR', 'Cera', 35);
let p5 = new produto_1.default('IKYTT', 'Rímel', 80);
let p6 = new produto_1.default('EWMKR', 'Secador', 200);
let p7 = new produto_1.default('WHUWF', 'Demaquilante', 60);
let p8 = new produto_1.default('REWOD', 'Acetona', 40);
let p9 = new produto_1.default('IEKFE', 'Batom', 25);
let p10 = new produto_1.default('DFJGI', 'Pente', 10);
c1.addProduto(p1);
c1.addProduto(p1);
c1.addProduto(p2);
c1.addProduto(p9);
